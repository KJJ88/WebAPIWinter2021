...
var drawScore = function(){
    ctx.fillStyle = 'white'
    ctx.fillText(Player.list[clientId].score, 0, 50)
    ctx.fillStyle = 'black'
}
...
var Player = function(initPack)
{
    ...
    self.draw = function(){
        ...
        // ctx.font = "30px Arial"
        ctx.drawImage(Sprites.player, self.x - Sprites.player.width/6, self.y - Sprites.player.height/4, Sprites.player.width/4, Sprites.player.height/4)
    }
...
var Bullet = function(initPack)
{
    ...
    self.draw = function(){
        ...
        ctx.drawImage(Sprites.fireball, self.x, self.y, Sprites.fireball.width/15, Sprites.fireball.height/15)
